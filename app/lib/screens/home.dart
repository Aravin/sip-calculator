          ...
          GridView.count(
            ...
            children: [
              ...
              _card(context, 'SIP vs Lumpsum', 'Compare\nStrategies',
                  Icons.compare_arrows, colorScheme.primary, () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (_) => const SipVsLumpsumScreen()));
              }),
              _card(context, 'Tax', 'Old vs New\nRegime', Icons.receipt_long,
              ...
              _card(context, 'SIP+Lumpsum', 'Combined Planner', Icons.merge,
                  colorScheme.primary, () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (_) => const CombinedScreen()));
              }),
              _card(context, 'Saved Plans', 'Bookmarked Calcs', Icons.bookmark,
